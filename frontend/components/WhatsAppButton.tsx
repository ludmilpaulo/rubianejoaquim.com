...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 px-3 py-1.5 bg-slate-900 text-white text-sm font-medium rounded-lg shadow-xl whitespace-nowrap opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none">
        Falar no WhatsApp
      </span>
    </a>
  )
