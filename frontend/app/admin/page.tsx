      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Total de Cursos</p>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Matrículas</p>
                <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{stats.totalEnrollments}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <p className="text-xs sm:text-sm font-medium text-gray-600">Pedidos de Mentoria</p>
          ...
          <div className="bg-white rounded-lg shadow p-4 sm:p-6">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{stats.pendingPayments}</p>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <Link
            href="/admin/cms"
            className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow ring-2 ring-amber-200"
          >
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Site CMS</h3>
            <p className="text-gray-600 text-sm">Homepage, serviços, navegação, leads e conteúdo público (API)</p>
          </Link>
          ...
          <Link
            ...
            className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow"
          >
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Portfolio (avançado)</h3>
            <p className="text-gray-600 text-sm">Projetos, testemunhos, Zenda e Django admin</p>
          </Link>
          ...
          >
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Pontos de Utilizadores</h3>
            </div>
