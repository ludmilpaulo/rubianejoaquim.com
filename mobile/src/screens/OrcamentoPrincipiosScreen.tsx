...
const SECTIONS = [
  ...
  },
  {
    ...
    points: [
      'Cliente paga 50.000 Kz. Alocação típica:',
      '25.000 Kz → desenvolvimento',
      '10.000 Kz → design e UI/UX',
      '5.000 Kz → testes e correções',
      '5.000 Kz → gestão do projeto',
      '5.000 Kz → margem da empresa',
    ],
